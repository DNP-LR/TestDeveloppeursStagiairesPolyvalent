...
public class DateToStringUtil {
    ...
    public static final DateTimeFormatter DATEFORMAT_UPDATE = DateTimeFormatter.ofPattern("MM/dd/yyyy");
    ...
    public static final DateTimeFormatter DATETIME_FORMAT_CONVERTOR2 = DateTimeFormatter
            .ofPattern("yyyy-MM-dd HH:mm:ss");

    public static final DateTimeFormatter DATETIME_FORMAT_CONVERTOR_V2 = DateTimeFormatter
            .ofPattern("dd/MM/yyyy HH:mm:ss");

    public static final DateTimeFormatter DATETIME_FORMAT_CONVERTOR_V3 = DateTimeFormatter
            .ofPattern("yyyy-MM-dd HH:mm:ss");

    public static final DateTimeFormatter DATETIME_SMS_FORMAT_CONVERTOR = DateTimeFormatter
            .ofPattern("dd/MM/yyyy HH:mm:ss");
    ...
    public static LocalDateTime convertorDateTime24H00(String dateText) {
        ...
        LocalDateTime ok = l != null ? l.atTime(LocalTime.MAX) : null;
